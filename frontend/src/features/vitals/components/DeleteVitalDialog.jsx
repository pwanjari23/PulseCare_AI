...
export const DeleteVitalDialog = ({ isOpen, onClose, record }) => {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs">
          ...
          >
            ...
            <p className="text-xs text-muted-foreground">
              Are you sure you want to delete vital sign record <span className="font-mono font-bold text-foreground">#{record.id}</span>?
            </p>
            ...
            <div className="flex items-center justify-end space-x-3 pt-2">
              ...
              >
                ...
                <span>{deleteMutation.isPending ? 'Deleting...' : 'Delete Record'}</span>
              </button>
            </div>
          </motion.div>
        </div>
