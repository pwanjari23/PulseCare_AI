/**
 * PulseCare AI - DeleteAccountDialog Component
 */
...
export const DeleteAccountDialog = ({ isOpen, onClose, onConfirm, isDeleting = false }) => {
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-background/80 backdrop-blur-xs font-sans">
        ...
        >
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="text-base font-bold text-foreground font-display">Delete Personal Account</h3>
          ...
          <div className="p-3.5 rounded-2xl bg-rose-500/10 border border-rose-500/20 text-xs text-rose-600 dark:text-rose-400 space-y-1">
            <p className="font-bold flex items-center gap-1">
              <AlertTriangle className="w-4 h-4" /> Permanent Data Deletion
            </p>
            <p className="leading-relaxed">
              Deleting your PulseCare AI account will purge your profile, saved preferences, and security access. Clinical records will remain archived per medical retention policies.
            </p>
          </div>
