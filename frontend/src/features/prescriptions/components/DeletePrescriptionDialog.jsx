...
import { generatePrescriptionCode } from '../utils/prescription.utils';

export const DeletePrescriptionDialog = ({ isOpen, onClose, prescription }) => {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs">
          ...
          >
            ...
            <div className="flex items-center space-x-3 text-rose-500">
              ...
              <div>
                <h3 className="text-base font-bold text-foreground">Delete Prescription</h3>
                <p className="text-xs text-muted-foreground">This action cannot be undone.</p>
              </div>
            </div>

            <p className="text-xs text-muted-foreground">
              Are you sure you want to delete prescription record <span className="font-mono font-bold text-primary">{code}</span>?
            </p>
            ...
            <div className="flex items-center justify-end space-x-3 pt-2">
              ...
              >
                ...
                <span>{deleteMutation.isPending ? 'Deleting...' : 'Delete Prescription'}</span>
              </button>
            </div>
          </motion.div>
        </div>
